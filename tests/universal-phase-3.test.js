...
test("routine title comparison is case-insensitive and ignores the current routine", () => {
  const routines = [{ id: "a", title: "Weekly Clean" }, { id: "b", title: "Quick tidy" }];
...
test("Routines retains direct Start and advanced editing while presenting one creation flow", () => {
...
test("starting a routine requests the shared focused cleaning experience", () => {
  const app = textFile("../src/App.jsx");
