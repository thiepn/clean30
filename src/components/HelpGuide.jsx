...
const guideSections = [
  ...
  {
    title: "Routines",
    body: "Routines are reusable cleaning checklists. Start, create, or edit them directly from Routines. Start with a room or the Task Library when you do not want to plan."
  },
  {
    title: "Progress",
